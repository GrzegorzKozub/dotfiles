...
() {
  ...
  function my_git_format() {
    ...
    (( VCS_STATUS_NUM_UNSTAGED && !VCS_STATUS_NUM_STAGED )) && prompt+=' '
    (( VCS_STATUS_NUM_UNSTAGED )) && prompt+="${MY_PROMPT_GIT_COLOR_UNSTAGED}${icon_unstaged}${VCS_STATUS_NUM_UNSTAGED}"
    (( VCS_STATUS_NUM_UNTRACKED && !VCS_STATUS_NUM_UNSTAGED )) && prompt+=' '
  ...
  typeset -g POWERLEVEL9K_VCS_{STAGED,UNSTAGED,MY_PROMPT_GIT_COLOR_UNTRACKED,MY_PROMPT_GIT_COLOR_CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND}_MAX_NUM=-1
