...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_FOREGROUND=$MY_PROMPT_CHAR_COLOR_INSERT_OK
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=$MY_PROMPT_CONTEXT_COLOR
  typeset -g POWERLEVEL9K_CONTEXT_{ROOT,REMOTE,REMOTE_SUDO}_FOREGROUND=$MY_PROMPT_CONTEXT_COLOR
  ...
  typeset -g POWERLEVEL9K_STATUS_{OK,ERROR}_FOREGROUND=$MY_PROMPT_STATUS_COLOR
